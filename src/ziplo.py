...
class ZiploApp(tk.Tk):
    ...
    def _generate_workflow_yaml(self):
        ...
        if btype == "pyinstaller":
            ...
            node_ver = node_var.get() if (node_var := node_ver) else "22"
            ...
            lines = [
                ...
                "        run: npm install",
                "",
                # Let electron-builder do everything — build AND publish.
                # --publish always + GH_TOKEN = electron-builder creates/updates
                # the GitHub release and uploads the installer directly.
                # This is the correct way to do Electron CI — no softprops needed.
