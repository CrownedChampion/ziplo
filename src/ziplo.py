...
class ZiploApp(tk.Tk):
    ...
    def _build_dropzone(self, parent):
        ...
        # Pack buttons FIRST (side=right) so they reserve space before
        # info (side=left) expands to fill the remainder — tkinter packing order matters
        btn_row = tk.Frame(top, bg=C["surface2"])
        btn_row.pack(side="right")
        tk.Button(btn_row, text="📁 Folder", font=F["small"],
                  bg=C["surface3"], fg=C["accent"],
                  activebackground=C["border"], activeforeground=C["accent_hover"],
                  relief="flat", padx=10, pady=5, cursor="hand2",
                  command=self._browse_source_folder).pack(side="left", padx=(4, 0))
        tk.Button(btn_row, text="🗜 Archive", font=F["small"],
                  bg=C["surface3"], fg=C["accent"],
                  activebackground=C["border"], activeforeground=C["accent_hover"],
                  relief="flat", padx=10, pady=5, cursor="hand2",
        ...
        tk.Label(info, text="Select a zip archive or a project folder",
